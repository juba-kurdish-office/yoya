...
module.exports = {
    ...
    .setID(`pause`)
    .setStyle("red")
    .setEmoji('945670433200541727');

    let button2 = new MessageButton()
    .setLabel(`Resume`)
    .setID(`resume`)
    .setStyle("green")
    .setEmoji('945670433007632467');

    let button3 = new MessageButton()
    .setLabel(`stop`)
    .setID(`stop`)
    .setStyle("green")
    .setEmoji('945670433166999604');
...
let rowss = new MessageActionRow()
    ...
    .addComponents(button1, button3, button4);
...
if (message.guild.me.voice.channel !== message.member.voice.channel) {
       ...
       if (b.clicker.id === message.author.id) {
        ...
        return await b.reply.send('Stopet!', true)
        
         }
         return await b.reply.send(`Only ${message.author.username} can stop! Please contact him to stop`, true)
